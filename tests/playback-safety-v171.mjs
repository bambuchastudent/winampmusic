...
assert.match(headerSource, /ad-indicator-v170\.js\?v=1711/);
...
assert.equal(a.document.getElementById('status').textContent, 'AD');
...
console.log('final trust cache + full-library resolver + iframe ad badge + diagnostics download v1.7.11: ok');
