(() => {
  ...
  function wrapDirectPlayback(value) {
    ...
    const wrapped = async (index) => {
      if (YOUTUBEJS_ONLY) return false;
      let result = false;
  ...
  function loadPlaybackNavigation() { if (window.__AMPULA_PLAYBACK_NAVIGATION_178__ || document.querySelector('script[data-ampula-playback-navigation-178]')) return; const script = document.createElement('script'); script.src = './playback-navigation-v178.js?v=188'; script.async = true; script.setAttribute('data-ampula-playback-navigation-178', '1'); document.head.appendChild(script); }
  function loadBackground() { if (document.querySelector('script[data-amp-background-150]')) return; const script = document.createElement('script'); script.src = './fast-background-v150.js?v=188'; script.async = true; script.setAttribute('data-amp-background-150', '1'); document.head.appendChild(script); }
  ...
  function loadYoutubeJsAudioFirst() {
    const start = () => {
      ...
      script.src = './youtubejs-audio-first-v181.js?v=190';
      script.async = true;
  ...
  if (YOUTUBEJS_ONLY) loadYoutubeJsAudioFirst();
  else setTimeout(loadYoutubeJsAudioFirst, 120);
  if (!YOUTUBEJS_ONLY) setTimeout(loadYoutubeEmbedRetry, 180);
