...
- [x] Update the branding contract test for Ámpula / ÁmpulaMP before implementation.
- [x] Rename current human/agent guidance to project Ámpula and player ÁmpulaMP.
